...
- Upstream: Workspace Manager.\n- Downstream: Quality Auditor (validation), OS Monitor Template assignment during scaffold.\n- Escalate ambiguity/research blockage/validation failure to Workspace Manager.
