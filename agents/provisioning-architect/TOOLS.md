...
- Allowed: web_search, generate_files, create_os_record, validate_provisioning.\n- Forbidden: modify READY OS, delete OS, access personal user files.
